...
class CreditNoteParserTest(unittest.TestCase):
    ...
    def test_uses_detail_invoice_instead_of_placeholder_reference(self):
        rows = []
        ...
        credit_note = make_row()
        credit_note[5] = "SR6907003"
        credit_note[6] = "03/07/2569"
        credit_note[8] = "IV0000000"
        credit_note[13] = "150.00"
        rows.append(credit_note)

        detail = make_row()
        detail[14] = "IVVPR6907999- 19"
        rows.append(detail)
        ...
        self.assertEqual(record["reference_invoice"], "IV0000000")
        self.assertEqual(record["applied_invoice"], "VPR6907999")

    def test_normalizes_buddhist_and_gregorian_years(…29663 tokens truncated…+https://github.com/rust-lang/crates.io-index"
